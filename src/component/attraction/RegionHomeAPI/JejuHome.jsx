...
function JejuHome () {
    ...
    const textAPI = async () => {
        try {
            ...
            const res = await axios.get(`https://apis.data.go.kr/B551011/KorService1/areaBasedList1?numOfRows=8&pageNo=1&MobileOS=ETC&MobileApp=jeju&_type=json&contentTypeId=12&areaCode=39&serviceKey=${serviceKey}`);
        ...
        <div className="mt-20 w-11/12 mx-auto">
            ...
            <div className="text-center content-center">
                <div class="grid grid-cols-4 gap-4">
                    {
                        jejuApi.slice(0,8).map((v) => (
                            <Link to={`/DetailJeju/${v.contentid}`} >
