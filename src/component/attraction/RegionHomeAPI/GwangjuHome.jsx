...
function GwangjuHome () {
    ...
    const textAPI = async () => {
        try {
            ...
            const res = await axios.get(`https://apis.data.go.kr/B551011/KorService1/areaBasedList1?numOfRows=8&pageNo=1&MobileOS=ETC&MobileApp=gwangju&_type=json&contentTypeId=12&areaCode=5&serviceKey=${serviceKey}`);
        ...
        <div className="mt-20 w-11/12 mx-auto">
            ...
            <div className="text-center content-center">
                <div class="grid grid-cols-4 gap-4">
                    {
                        gwangjuApi.slice(0,8).map((v) => (
                            <div className="p-10 bg-slate-200" key={v.contentid}>
                                <Link to={`/DetailGwangju/${v.contentid}`} >
