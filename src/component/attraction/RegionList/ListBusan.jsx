...
function ListBusan () {
    ...
    const textAPI = async () => {
        try {
            ...
            const res = await axios.get(`https://apis.data.go.kr/B551011/KorService1/areaBasedList1?numOfRows=30&pageNo=${page}&&MobileOS=ETC&MobileApp=busan&_type=json&contentTypeId=12&areaCode=6&serviceKey=${serviceKey}`);
            ...
            setBusanApi((prevData) => [...prevData, ...newData]);
        } catch (err) {
            setError(err);
        }
        setLoading(false);
                ...
                <div class="grid grid-cols-4 gap-4">
                    {busanApi &&
                        ...
                        <div key={list.contentid} >
                            <Link to={`/DetailBusan/${list.contentid}`}>
