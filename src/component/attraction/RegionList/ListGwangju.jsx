...
function ListGwangju () {
    ...
    const textAPI = async () => {
        try {
            ...
            const res = await axios.get(`https://apis.data.go.kr/B551011/KorService1/areaBasedList1?numOfRows=30&pageNo=${page}&&MobileOS=ETC&MobileApp=daegu&_type=json&contentTypeId=12&areaCode=5&serviceKey=${serviceKey}`);
            ...
            setGwangjuApi((prevData) => [...prevData, ...newData]);
        } catch (err) {
            setError(err);
        }
        setLoading(false);
                ...
                <div class="grid grid-cols-4 gap-4">
                    {gwangjuApi &&
                        ...
                        <div key={list.contentid} >
                            <Link to={`/DetailGwangju/${list.contentid}`}>
