...
function ListJeju () {
    ...
    const textAPI = async () => {
        try {
            ...
            const res = await axios.get(`https://apis.data.go.kr/B551011/KorService1/areaBasedList1?numOfRows=30&pageNo=${page}&&MobileOS=ETC&MobileApp=daegu&_type=json&contentTypeId=12&areaCode=39&serviceKey=${serviceKey}`);
            ...
            setJejuApi((prevData) => [...prevData, ...newData]);
        } catch (err) {
            setError(err);
        }
        setLoading(false);
                ...
                <div class="grid grid-cols-4 gap-4">
                    {jejuApi &&
                        ...
                        <div key={list.contentid} >
                            <Link to={`/DetailJeju/${list.contentid}`}>
